...
namespace SimulationOfBusRoute.Presenters
{
    class CStationsEditorPresenter : CBasePresenter<CMainModel, IStationsEditorView>
    {
        ...
        {
            int numOfStations = mModel.CurrNumOfStations;

            mView.AutoGeneratedTextHeader = string.Format(Properties.Resources.mHeaderTemplateForStationsEditor,
                                                          Environment.NewLine,
                                                          numOfStations,
                                                          numOfStations);

            mView.TextEditor.Text = string.Format(Properties.Resources.mStationsEditorDefaultProgramTemplate,
                                                  Environment.NewLine,
                                                  "beta",
                                                  "*");
        }
